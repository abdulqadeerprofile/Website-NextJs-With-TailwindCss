        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              your one-stop shop for high-quality automobile parts and accessories.
              </p>
            </div>
